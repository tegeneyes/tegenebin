...
const en: Dict = {
  ...
  "phone.shared_saving": "Phone shared. Saving it now…",
  ...
  "wallet.proof_desc_sms": "Paste the full telebirr or CBE confirmation SMS for {amount} ETB. It is checked and credited automatically.",
  "wallet.sms_hint": "Paste the whole message exactly as received (it must contain the transaction number, e.g. DE67LY0HPP). Each SMS can only be used once.",
...
const am: Dict = {
  ...
  "phone.shared_saving": "ስልክ ተጋርቷል። እያስቀመጥን ነው…",
  ...
  "wallet.proof_desc_sms": "ለ {amount} ብር የተላከውን ሙሉ የቴሌብር ወይም የCBE ማረጋገጫ ኤስኤምኤስ ይለጥፉ። በራስ-ሰር ተረጋግጦ ይከፈላል።",
  "wallet.sms_hint": "መልዕክቱን እንደደረሰዎት ሙሉውን ይለጥፉ (የግብይት ቁጥሩን መያዝ አለበት፣ ለምሳሌ DE67LY0HPP)። እያንዳንዱ ኤስኤምኤስ አንድ ጊዜ ብቻ ይሰራል።",
