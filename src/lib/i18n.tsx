...
const en: Dict = {
  ...
  "wallet.proof_desc_sms": "Paste the telebirr or CBE confirmation SMS for {amount} ETB to speed up review (optional).",
  "wallet.sms_hint": "Optional. Pasting the full SMS helps us review faster. Each SMS can only be used once.",
...
const am: Dict = {
  ...
  "wallet.proof_desc_sms": "ለ {amount} ብር የተላከውን የቴሌብር ወይም የCBE ማረጋገጫ ኤስኤምኤስ ይለጥፉ (አማራጭ)። ግምገማው በፍጥነት ይጠናቀቃል።",
  "wallet.sms_hint": "አማራጭ። ሙሉውን ኤስኤምኤስ ካለጠፉ ግምገማው በፍጥነት ይከናወናል። እያንዳንዱ ኤስኤምኤስ አንድ ጊዜ ብቻ ይሰራል።",
